        ...
        <div class="modal">
            ...
            <div class="modal-body">
                <div class="flex cta-wrapper">
                    <button @click="buyWithCash" class="modal-btn flex flex-auto" v-if="useCash">
                        <img src="../assets/img/money.png" />{{ compCashPrice }}
                    </button>
                    <!--  -->
                    <button @click="buyWithGold" class="modal-btn flex flex-auto" v-if="useGold">
