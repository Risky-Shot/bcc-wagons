    ...
    watch: {
        curItem(newVal, oldVal) {
            ...
            if (oldValue > -1 && !this.isOwned(oldValue)) {
                this.$store.dispatch(
                    "setCompCashPrice",
                    this.compCashPrice - parseInt(this.wagonComps[oldValue]["cashPrice"])
                );

                this.$store.dispatch(
                    "setCompGoldPrice",
                    this.compGoldPrice - parseInt(this.wagonComps[oldValue]["goldPrice"])
                );
            }
            ...
            api
                .post(this.label.replace(/\s+/g, ""), {
                    ...
                    hash:
                        this.curItem - 1 == -1
                            ? ""
                            : this.wagonComps[this.curItem - 1]["hash"],
                })
                .catch((e) => {
